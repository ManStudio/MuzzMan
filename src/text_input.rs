...
impl EntityInputHandler for TextInput {
    ...
    fn replace_text_in_range(
        ...
        self.scroll_handle.scroll_to_item(1);
...
impl TextElement {
    pub fn compute_line(&self, cx: &App, window: &Window) -> ShapedLine {
...
impl Element for TextElement {
    ...
    fn request_layout(
        ...
        style.size.width = self.compute_line(cx, window).width.into();
    ...
    fn prepaint(
        ...
        let line = self.compute_line(cx, window);
...
impl Render for TextInput {
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        div()
            ...
            .child(div().child(TextElement { input: cx.entity() }))
            .child(div()) // item to scroll to
    }
}
