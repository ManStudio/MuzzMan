...
use blobsman_graphics::{
    gpui::{
        self, AnyElement, AssetSource, Div, Global, Hsla, Inspector, Interactivity, Length,
        ScrollAnchor, ScrollHandle, Size, TitlebarOptions, WindowDecorations, anchored, deferred,
        svg,
    },
            ...
            |window, cx| {
                ...
                cx.new(|cx| {
                    ...
                    BlobsManApp {
                        ...
                        tree: cx.new(|cx|
                            Tree{
                                entries: vec![cx.new(|cx|Entry{
                                    name: "Testing".into(),
                                    entries: vec![
                                        cx.new(|cx|Entry{ name: "1".into(), entries: vec![
                                            cx.new(|cx|Entry{ name: "1_1".into(), entries: vec![
                                                cx.new(|cx|Entry{ name: "1_1_1".into(), entries: vec![
                                                    cx.new(|cx|Entry{ name: "1_1_1_1".into(), entries: vec![
                                                        cx.new(|cx|Entry{ name: "This is a really really long, entry name to see how the scroll will work on something with a long name. This should be longer or is enough?".into(), entries: vec![
                                                            cx.new(|cx|Entry{ name: "Nice!".into(), entries: vec![], ..Entry::new(cx) }),
                                                        ], ..Entry::new(cx) }),
                                                    ], ..Entry::new(cx) }),
                                                    cx.new(|cx|Entry{ name: "1_1_1_2".into(), entries: vec![], ..Entry::new(cx) }),
                                                    cx.new(|cx|Entry{ name: "1_1_1_3".into(), entries: vec![], ..Entry::new(cx) }),
                                                ], ..Entry::new(cx) }),
                                                cx.new(|cx|Entry{ name: "1_1_2".into(), entries: vec![], ..Entry::new(cx) }),
                                                cx.new(|cx|Entry{ name: "1_1_3".into(), entries: vec![], ..Entry::new(cx) }),
                                            ], ..Entry::new(cx) }),
                                            cx.new(|cx|Entry{ name: "1_2".into(), entries: vec![
                                                cx.new(|cx|Entry{ name: "1_2_1".into(), entries: vec![], ..Entry::new(cx) }),
                                                cx.new(|cx|Entry{ name: "1_2_2".into(), entries: vec![], ..Entry::new(cx) }),
                                                cx.new(|cx|Entry{ name: "1_2_3".into(), entries: vec![], ..Entry::new(cx) }),
                                            ], ..Entry::new(cx) }),
                                            cx.new(|cx|Entry{ name: "1_3".into(), entries: vec![
                                                cx.new(|cx|Entry{ name: "1_3_1".into(), entries: vec![], ..Entry::new(cx) }),
                                                cx.new(|cx|Entry{ name: "1_3_2".into(), entries: vec![], ..Entry::new(cx) }),
                                                cx.new(|cx|Entry{ name: "1_3_3".into(), entries: vec![], ..Entry::new(cx) }),
                                            ], ..Entry::new(cx) }),
                                        ], ..Entry::new(cx) }),
                                        cx.new(|cx|Entry{ name: "2".into(), entries: vec![
                                            cx.new(|cx|Entry{ name: "2_1".into(), entries: vec![
                                                cx.new(|cx|Entry{ name: "2_1_1".into(), entries: vec![
                                                    cx.new(|cx|Entry{ name: "2_1_1_1".into(), entries: vec![], ..Entry::new(cx) }),
                                                    cx.new(|cx|Entry{ name: "2_1_1_2".into(), entries: vec![], ..Entry::new(cx) }),
                                                    cx.new(|cx|Entry{ name: "2_1_1_3".into(), entries: vec![], ..Entry::new(cx) }),
                                                ], ..Entry::new(cx) }),
                                                cx.new(|cx|Entry{ name: "2_1_2".into(), entries: vec![], ..Entry::new(cx) }),
                                                cx.new(|cx|Entry{ name: "2_1_3".into(), entries: vec![], ..Entry::new(cx) }),
                                            ], ..Entry::new(cx) }),
                                            cx.new(|cx|Entry{ name: "2_2".into(), entries: vec![
                                                cx.new(|cx|Entry{ name: "2_2_1".into(), entries: vec![], ..Entry::new(cx) }),
                                                cx.new(|cx|Entry{ name: "2_2_2".into(), entries: vec![], ..Entry::new(cx) }),
                                                cx.new(|cx|Entry{ name: "2_2_3".into(), entries: vec![], ..Entry::new(cx) }),
                                            ], ..Entry::new(cx) }),
                                            cx.new(|cx|Entry{ name: "2_3".into(), entries: vec![
                                                cx.new(|cx|Entry{ name: "2_3_1".into(), entries: vec![], ..Entry::new(cx) }),
                                                cx.new(|cx|Entry{ name: "2_3_2".into(), entries: vec![], ..Entry::new(cx) }),
                                                cx.new(|cx|Entry{ name: "2_3_3".into(), entries: vec![], ..Entry::new(cx) }),
                                            ], ..Entry::new(cx) }),
                                        ], ..Entry::new(cx) }),
                                        cx.new(|cx|Entry{ name: "3".into(), entries: vec![
                                            cx.new(|cx|Entry{ name: "3_1".into(), entries: vec![
                                                cx.new(|cx|Entry{ name: "3_1_1".into(), entries: vec![
                                                    cx.new(|cx|Entry{ name: "3_1_1_1".into(), entries: vec![], ..Entry::new(cx) }),
                                                    cx.new(|cx|Entry{ name: "3_1_1_2".into(), entries: vec![], ..Entry::new(cx) }),
                                                    cx.new(|cx|Entry{ name: "3_1_1_3".into(), entries: vec![], ..Entry::new(cx) }),
                                                ], ..Entry::new(cx) }),
                                                cx.new(|cx|Entry{ name: "3_1_2".into(), entries: vec![], ..Entry::new(cx) }),
                                                cx.new(|cx|Entry{ name: "3_1_3".into(), entries: vec![], ..Entry::new(cx) }),
                                            ], ..Entry::new(cx) }),
                                            cx.new(|cx|Entry{ name: "3_2".into(), entries: vec![
                                                cx.new(|cx|Entry{ name: "3_2_1".into(), entries: vec![], ..Entry::new(cx) }),
                                                cx.new(|cx|Entry{ name: "3_2_2".into(), entries: vec![], ..Entry::new(cx) }),
                                                cx.new(|cx|Entry{ name: "3_2_3".into(), entries: vec![], ..Entry::new(cx) }),
                                            ], ..Entry::new(cx) }),
                                            cx.new(|cx|Entry{ name: "3_3".into(), entries: vec![
                                                cx.new(|cx|Entry{ name: "3_3_1".into(), entries: vec![], ..Entry::new(cx) }),
                                                cx.new(|cx|Entry{ name: "3_3_2".into(), entries: vec![], ..Entry::new(cx) }),
                                                cx.new(|cx|Entry{ name: "3_3_3".into(), entries: vec![], ..Entry::new(cx) }),
                                            ], ..Entry::new(cx) }),
                                        ], ..Entry::new(cx) }),
                                    ],
                                    ..Entry::new(cx)
